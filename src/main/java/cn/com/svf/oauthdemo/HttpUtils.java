...
public class HttpUtils {
    ...
    public String postForm(String url) throws SocketTimeoutException,
            IOException {
        return doRequest("POST", url, "", 60000, 60000, CTYPE_FORM, null);
    }
    ...
    public String postForm(String url, Map<String, String> params)
            throws SocketTimeoutException, IOException {
        return doRequest("POST", url, buildQuery(params), 60000, 60000,
                CTYPE_FORM, null);
    }
    ...
    public String getForm(String url) throws SocketTimeoutException,
            IOException {
        return doRequest("GET", url, "", 60000, 60000, CTYPE_FORM, null);
    }
    ...
    public String getForm(String url, Map<String, String> params)
            throws SocketTimeoutException, IOException {
        return doRequest("GET", url, buildQuery(params), 60000, 60000,
                CTYPE_FORM, null);
    }
